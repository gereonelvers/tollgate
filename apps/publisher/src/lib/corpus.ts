...
The Tollgate primitive (paid-action manifests at /.well-known/faregate.json) is the smallest change a website can make to enter this market. The site declares what's for sale and at what price; Lightning handles the settlement. No accounts, no contracts, no marketplaces taking 30%.`,
  },
  {
