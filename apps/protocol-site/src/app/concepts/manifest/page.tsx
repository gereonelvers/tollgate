  ...
  return (
    <DocLayout activePath="/concepts/manifest" toc={TOC}>
      <PageHeader
        kicker="Concepts"
        title="The manifest"
        lead="A single JSON file at /.well-known/tollgate.json that declares everything an agents402 publisher offers. Cacheable, versioned, signed by the publisher's service key."
      />
      ...
      <CodeBlock filename="/.well-known/tollgate.json" lang="json">
{`{
  "version": "0.1",
  "service": { … },
  "actions": [ … ],
  "receipts": {
    ...
    "algorithm":  "ed25519"
      ...
      <UL>
        <LI>
          The manifest path is <InlineCode>/.well-known/tollgate.json</InlineCode> on the canonical
