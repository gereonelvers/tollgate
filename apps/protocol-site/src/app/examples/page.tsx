  ...
  return (
    <DocLayout activePath="/examples" toc={TOC}>
      <PageHeader
        kicker="Resources"
        title="Examples"
        lead="Drop-in reference snippets for the most common agents402 implementations. Each example assumes the canonical /.well-known/tollgate.json manifest is already in place."
      />
...
{`export default {
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/.well-known/tollgate.json") return manifestResponse(env);
